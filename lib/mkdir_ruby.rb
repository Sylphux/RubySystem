...
def verify_command_argument
    if ARGV.empty?
        ...
        puts "You can now start mkdir_ruby with the command 'mkrb'"
...
def show_help
    ...
    puts
    puts "If you want to simply create an alias for the program"
    puts "cd into the /bin directory and launch 'ruby mkdir_ruby -als'"
    puts
end
